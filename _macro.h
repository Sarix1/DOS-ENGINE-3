...
#define ptrWrapEnd(ptr,start,end)    if ((ptr)>=(end))    (ptr)=(start)
#define ptrWrapStart(ptr,start,end)  if ((ptr)<(start))   (ptr)=(end-1)
#define ptrIncAndWrap(ptr,start,end) if ((++ptr)>=(end))  (ptr)=(start)
#define ptrDecAndWrap(ptr,start,end) if ((--ptr)<(start)) (ptr)=(end-1)
